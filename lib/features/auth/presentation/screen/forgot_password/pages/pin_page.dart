...
import 'package:laza_applicaiton/features/auth/presentation/screen/forgot_password/pages/new_password_page.dart';
...
class PinPage extends StatefulWidget {
  ...
  const PinPage({super.key, required this.userId, required this.email});
      ...
      bottomNavigationBar: BlocConsumer<ConfirmationBloc, ConfirmationState>(
        ...
        listener: (context, state) {
          if (state is ConfirmationLoaded) {
            AppRoute.go(NewPasswordPage(token: state.authToken.accessToken));
